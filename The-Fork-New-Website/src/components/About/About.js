    ...
    render() {
        return (
            <section class="text-center my-5 container">
                ...
                <h2 class="h1-responsive font-weight-bold my-5">Who are we?</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h5 class="font-weight-bold my-4">Singular</h5>
                    </div>

                    <div class="col-md-4">
                        <Link to="/Team"><button id="team-btn" type="button" class="font-weight-bold shadow-lg text-light btn my-3">The team</button></Link>
                    </div>

                    <div class="col-md-4">
                        <h5 class="font-weight-bold my-4">Blockchain</h5>
                    </div>
